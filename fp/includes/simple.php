...
#EDIT THE FOLLOWING:
$toAddress = "jennifer.villacis@seattlecentral.edu";  //place your/your client's email address here
$toName = "Jennifer Villacis"; //place your client's name here
$website = "www.jencodes.dreamhosters.com/web150";  //place NAME of your client's website here
#--------------END CONFIG AREA ------------------------#
...
?>
	...
	<form class="form-contact" action="<?php echo basename($_SERVER['PHP_SELF']); ?>" method="post">
	<div>
		<label>
